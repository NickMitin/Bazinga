...
final class bmReferencePage extends bmAdminPage
{
	/*FF::AC::CGIPROPERTIES::{*/
	...
	private $referencedObjectTypes = array(
		BM_RT_MAIN => 'Главный',
		BM_RT_REFERRED => 'Зависимый',
		BM_RT_ADDITIONAL => 'Дополнительный'
	);
	...
	public function generate()
	{
		...
		foreach ($fields as $field)
		{
			...
			{
				$dataObjectMap = new bmDataObjectMap($this->application, array(
					'identifier' => $referencedObjectId,
					'load' => true
				));
